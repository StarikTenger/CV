...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{{\footnotesize\faMapMarker*}\hspace*{0.13cm}Grenoble, France}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{mailto:stariktenger@gmail.com}{{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}stariktenger@gmail.com}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:06 04 17 98 94}{{\footnotesize\faPhone*}\hspace*{0.13cm}06 04 17 98 94}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://github.com/stariktenger}{{\footnotesize\faGithub}\hspace*{0.13cm}stariktenger}}%
    \end{header}
